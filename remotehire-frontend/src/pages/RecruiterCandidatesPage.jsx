            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border font-semibold cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 ${
                    darkMode
                      ? "bg-slate-700 border-slate-600 text-white placeholder-slate-400 focus:ring-indigo-500/50 focus:border-indigo-500"
                      : "bg-white border-blue-200 text-slate-900 placeholder-slate-400 focus:ring-blue-500/30 focus:border-blue-500"
                  }`}
                />
              </div>
              {scheduleMessage && (
